...
export default function ChatPage() {
    return (
        <div className="min-h-screen bg-transparent flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <nav className="fixed top-0 w-full pt-8 pb-12 bg-gradient-to-b from-black/30 to-transparent flex items-start justify-between px-6 md:px-12 z-20 pointer-events-none">
